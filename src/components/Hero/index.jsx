...
export default function Hero() {
  return (
    <div className="container mx-auto">
      <div className="flex flex-col gap-[44px] p-5 pt-6  min-h-screen h-auto md:justify-center md:p-0 lg:min-h-fit lg:justify-start">
        <div className="flex flex-col gap-8">
          <section className="flex flex-col gap-5 md:items-center text-center">
            <h1 className="text-[42px] md:text-5xl md:w-4/5 font-bold font-head text-primary-100">
              The platform commerce is built on.
            </h1>
            <p className="text-lg font-body text-black-300 md:w-2/3">
              Millions of the world's most successful brands trust Shopify to
              sell, ship and process payments anywhere.
            </p>
          </section>
          <div className="flex flex-col md:flex-row justify-center gap-[18px] md:gap-[30px]">
            ...
            <div className="absolute top-[28%] left-1 border-[0.5px] border-[#E2E2E2] rounded sales-card bg-white flex flex-col gap-2 font-body p-2 w-[96px] md:w-[196px] md:gap-4 md:border md:p-3.5">
              <div className="flex flex-col gap-0.5">
                ...
                <div className="w-full flex items-end justify-between">
                  <h4 className="text-xs text-[#064A4A] font-bold md:text-2xl">$218</h4>
                  <img className="w-8 h-auto object-cover md:w-[65px]" src="/chart.svg" alt="chart" />
                </div>
              </div>
